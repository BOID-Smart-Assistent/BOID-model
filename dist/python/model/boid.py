...
# sources: llm/llm_rules_output.proto, algorithm/schedule.proto, common/authenticate.proto, common/rule.proto, common/world.proto
...
class Schedule(betterproto.Message):
    ...
    timeslots: List["Timeslot"] = betterproto.message_field(1)
...
class Timeslot(betterproto.Message):
    ...
    presentation: "Presentation" = betterproto.message_field(2)
